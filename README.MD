...
## Using Test-IMO with non-default configuration
...
$TestResults = Test-IMO -ReturnResults -ExcludeDomains 'ad.evotec.pl' -Sources $Sources -Configuration $OutputOrderedDictionary
