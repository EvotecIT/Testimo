...
$Configuration = @{
    Information = @{
        ...
        Manifest          = @{
            ...
            RequiredModules      = @(
                @{ ModuleName = 'PSSharedGoods'; ModuleVersion = "0.0.86"; Guid = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe' }
                @{ ModuleName = 'PSWinDocumentation.AD'; ModuleVersion = "0.1.9"; Guid = 'a46f9775-04d2-4423-9631-01cfda42b95d' }
                @{ ModuleName = 'PSWinDocumentation.DNS'; ModuleVersion = "0.0.5"; Guid = '462dd5e2-f32a-4263-bff5-22edf28882d0' }
