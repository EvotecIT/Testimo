...
$Configuration = @{
    Information = @{
        ...
        Manifest          = @{
            ...
            RequiredModules      = @(
                @{ ModuleName = 'PSSharedGoods'; ModuleVersion = "0.0.108"; Guid = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe' }
                ...
                @{ ModuleName = 'PSEventViewer'; ModuleVersion = "1.0.10"; Guid = '5df72a79-cdf6-4add-b38d-bcacf26fb7bc' }
                @{ ModuleName = 'PSWriteHTML'; ModuleVersion = "0.0.69"; Guid = 'a7bdf640-f5cb-4acf-9de0-365b322d245c' }
                @{ ModuleName = 'ADEssentials'; ModuleVersion = "0.0.27"; Guid = '9fc9fd61-7f11-4f4b-a527-084086f1905f' }
            )
        }
    }
    Options     = @{
