...
<#
$Script:SBForestRolesTest = {
    Test-Value -TestName 'SchemaMasterAvailability' @args
}
$Script:SBForestRolesTest2 = {
    Test-Value -TestName 'DomainNamingMasterAvailability' @args
}
#>