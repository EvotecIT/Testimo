...
$Script:SBDomainControllersLDAP_Port = {
    Test-Value -TestName "Domain Controller - $($DomainController.HostName) | LDAP Port is Available" -Property 'LDAP' @args
}
$Script:SBDomainControllersLDAP_PortSSL = {
    Test-Value -TestName "Domain Controller - $($DomainController.HostName) | LDAP SSL Port is Available" -Property 'LDAPS' @args
}
