...
$WindowsRolesAndFeatures = @{
    ...
    Tests  = [ordered] @{
        ActiveDirectoryDomainServices = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'Active Directory Domain Services' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
        ...
        DNSServer                     = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'DNS Server' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
        ...
        FileandStorageServices        = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'File and Storage Services' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
        ...
        FileandiSCSIServices        = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'File and iSCSI Services' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
        ...
        FileServer        = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'File Server' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
        ...
        StorageServices        = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'Storage Services' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
        ...
        WindowsPowerShell51           = @{
            ...
            Parameters = @{
                WhereObject   = { $_.DisplayName -eq 'Windows PowerShell 5.1' }
                Property      = 'Installed'
                ExpectedValue = $true
                OperationType = 'eq'
            }
